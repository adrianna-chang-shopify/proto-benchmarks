    ...
    module Protoboeuf
      class Envelope
        ...
        def decode_from(buff, index, len)
          ...
          while true
            ...
            if tag == 0x42
              ...
              @resource =
                Observe::Proto::Protoboeuf::Resource.allocate.decode_from(
                  buff,
                  index,
                  index += msg_len
                )
            ...
            if tag == 0x4a
              ...
              @context =
                Observe::Proto::Protoboeuf::Context.allocate.decode_from(
                  buff,
                  index,
                  index += msg_len
                )
            ...
            if tag == 0x52
              ...
              @value =
                ::ProtoBoeuf::Google::Protobuf::Any.allocate.decode_from(
                  buff,
                  index,
                  index += msg_len
                )
        ...
        def to_h
          ...
          result["resource".to_sym] = @resource.to_h
          result["context".to_sym] = @context.to_h
          result["value".to_sym] = @value.to_h
          result
        end
      end
      class Context
        ...
        def shop_id=(v)
          unless -9_223_372_036_854_775_808 <= v &&
            ...
            raise RangeError,
                  "Value (#{v}) for field shop_id is out of bounds (-9223372036854775808..9223372036854775807)"
          end
        ...
        def pod_id=(v)
          unless -2_147_483_648 <= v && v <= 2_147_483_647
            raise RangeError,
                  "Value (#{v}) for field pod_id is out of bounds (-2147483648..2147483647)"
          end
        ...
        def api_client_id=(v)
          unless -9_223_372_036_854_775_808 <= v &&
                   v <= 9_223_372_036_854_775_807
            raise RangeError,
                  "Value (#{v}) for field api_client_id is out of bounds (-9223372036854775808..9223372036854775807)"
          end
        ...
        def initialize(
          ...
          unless -9_223_372_036_854_775_808 <= shop_id &&
                   shop_id <= 9_223_372_036_854_775_807
            raise RangeError,
                  "Value (#{shop_id}) for field shop_id is out of bounds (-9223372036854775808..9223372036854775807)"
          end
          @shop_id = shop_id

          unless -2_147_483_648 <= pod_id && pod_id <= 2_147_483_647
            raise RangeError,
                  "Value (#{pod_id}) for field pod_id is out of bounds (-2147483648..2147483647)"
          end
          @pod_id = pod_id
          ...
          unless -9_223_372_036_854_775_808 <= api_client_id &&
                   api_client_id <= 9_223_372_036_854_775_807
            raise RangeError,
                  "Value (#{api_client_id}) for field api_client_id is out of bounds (-9223372036854775808..9223372036854775807)"
          end
        ...
        def to_h
          result = {}
          result["shop_id".to_sym] = @shop_id
          result["pod_id".to_sym] = @pod_id
          result["request_id".to_sym] = @request_id
          result["entrypoint".to_sym] = @entrypoint
          result["api_client_id".to_sym] = @api_client_id
          result["database_name".to_sym] = @database_name
          result
        end
      end
      class Resource
        ...
        attr_reader :k8s_cluster_name

        attr_reader :k8s_pod_name

        attr_reader :k8s_pod_ip

        attr_reader :k8s_node_name

        attr_reader :k8s_node_ip

        attr_reader :k8s_namespace_name

        attr_reader :cloud_region

        attr_reader :cloud_provider

        attr_reader :cloud_account_id

        attr_reader :deployment_worker_type

        attr_reader :process_command

        attr_reader :process_runtime_name

        attr_reader :process_runtime_version

        attr_reader :process_runtime_description
        ...
        def k8s_namespace_name=(v)
          @k8s_namespace_name = v
        end
        ...
        def cloud_provider=(v)
          @cloud_provider = v
        end

        def cloud_account_id=(v)
          @cloud_account_id = v
        end

        def deployment_worker_type=(v)
          @deployment_worker_type = v
        end

        def process_command=(v)
          @process_command = v
        end

        def process_runtime_name=(v)
          @process_runtime_name = v
        end

        def process_runtime_version=(v)
          @process_runtime_version = v
        end

        def process_runtime_description=(v)
          @process_runtime_description = v
        end

        def service_version=(v)
          @service_version = v
        end
        ...
        def initialize(
          ...
          @deployment_worker_type = deployment_worker_type

          @process_command = process_command

          @process_runtime_name = process_runtime_name

          @process_runtime_version = process_runtime_version

          @process_runtime_description = process_runtime_description
        ...
        def to_h
          result = {}
          result["k8s_cluster_name".to_sym] = @k8s_cluster_name
          result["k8s_pod_name".to_sym] = @k8s_pod_name
          result["k8s_pod_ip".to_sym] = @k8s_pod_ip
          result["k8s_node_name".to_sym] = @k8s_node_name
          result["k8s_node_ip".to_sym] = @k8s_node_ip
          result["k8s_namespace_name".to_sym] = @k8s_namespace_name
          result["cloud_region".to_sym] = @cloud_region
          result["cloud_provider".to_sym] = @cloud_provider
          result["cloud_account_id".to_sym] = @cloud_account_id
          result["deployment_worker_type".to_sym] = @deployment_worker_type
          result["process_command".to_sym] = @process_command
          result["process_runtime_name".to_sym] = @process_runtime_name
          result["process_runtime_version".to_sym] = @process_runtime_version
          result[
            "process_runtime_description".to_sym
          ] = @process_runtime_description
          result["service_version".to_sym] = @service_version
          result["service_name".to_sym] = @service_name
          result["rails_version".to_sym] = @rails_version
          result
        end
      end
    end
