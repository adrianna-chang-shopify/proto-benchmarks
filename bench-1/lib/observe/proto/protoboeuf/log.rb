        ...
        while true
          ...
          if tag == 0x62
            ...
            while tag == 0x62
              ...
              map[key] = Observe::Proto::Value.allocate.decode_from(
                buff,
                index,
                index += msg_len
              )
      ...
      def decode_from(buff, index, len)
        ...
        while true
          ...
          if tag == 0x2a
            ...
            @string_array_value =
              Observe::Proto::StringArrayValue.allocate.decode_from(
                buff,
                index,
                index += msg_len
              )
          ...
          if tag == 0x32
            ...
            @int_array_value =
              Observe::Proto::IntArrayValue.allocate.decode_from(
                buff,
                index,
                index += msg_len
              )
          ...
          if tag == 0x3a
            ...
            @double_array_value =
              Observe::Proto::DoubleArrayValue.allocate.decode_from(
                buff,
                index,
                index += msg_len
              )
          ...
          if tag == 0x42
            ...
            @bool_array_value =
              Observe::Proto::BoolArrayValue.allocate.decode_from(
                buff,
                index,
                index += msg_len
              )
